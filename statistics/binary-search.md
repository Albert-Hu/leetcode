# List of All Questions in Binary Search

**Total Questions: 98, Easy: 24, Medium: 49, Hard: 25, latest updated at 2021/03/25.**
...
- [array, hash-table, math](#array-hash-table-math)
- [array, heap](#array-heap)
- [array, segment-tree](#array-segment-tree)
- [array, string](#array-string)
- [array, two-pointers](#array-two-pointers)
- [binary-indexed-tree, divide-and-conquer, segment-tree, sort](#binary-indexed-tree-divide-and-conquer-segment-tree-sort)
- [binary-indexed-tree, ordered-map, segment-tree](#binary-indexed-tree-ordered-map-segment-tree)
- [bit-manipulation, segment-tree](#bit-manipulation-segment-tree)
- [depth-first-search, graph, union-find](#depth-first-search-graph-union-find)
- [depth-first-search, heap, union-find](#depth-first-search-heap-union-find)
- [dynamic-programming, greedy](#dynamic-programming-greedy)
- [dynamic-programming, math](#dynamic-programming-math)
- [dynamic-programming, queue](#dynamic-programming-queue)
- [dynamic-programming, sort](#dynamic-programming-sort)
- [greedy, math](#greedy-math)
- [greedy, sliding-window, two-pointers](#greedy-sliding-window-two-pointers)
- [hash-table, random, sort](#hash-table-random-sort)
- [hash-table, sort, two-pointers](#hash-table-sort-two-pointers)
- [hash-table, suffix-array](#hash-table-suffix-array)
...
## binary-indexed-tree, divide-and-conquer, segment-tree, sort
...
## binary-indexed-tree, ordered-map, segment-tree
...
## depth-first-search, heap, union-find
