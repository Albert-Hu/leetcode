# List of All Questions in Greedy

**Total Questions: 118, Easy: 24, Medium: 58, Hard: 36, latest updated at 2021/03/25.**

- [array, dynamic-programming](array-dynamic-programming)
- [array, math](array-math)
- [array, queue](array-queue)
- [backtracking, dynamic-programming, string](backtracking-dynamic-programming-string)
...
- [binary-search, sliding-window, two-pointers](binary-search-sliding-window-two-pointers)
- [dynamic-programming, math](dynamic-programming-math)
- [graph, union-find](graph-union-find)
- [hash-table, heap](hash-table-heap)
- [heap, queue, stack](heap-queue-stack)
- [heap, sort](heap-sort)
- [heap, sort, string](heap-sort-string)
- [line-sweep, sort](line-sweep-sort)
- [math, sort](math-sort)
- [segment-tree, sort](segment-tree-sort)
